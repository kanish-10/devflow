    ...
    <div className="absolute top-full z-10 mt-3 w-full rounded-xl bg-light-800 py-5 shadow-sm dark:bg-dark-400">
      ...
      <div className="space-y-5">
        ...
        {isLoading ? (
          ...
          <div className="custom-scrollbar flex flex-col gap-0.5">
            {result.length > 0 ? (
              result.map((item: any, index: number) => (
                <Link
                  className="flex w-full cursor-pointer items-start gap-3 px-3 py-2.5 hover:bg-light-700/50 dark:bg-dark-500/50"
